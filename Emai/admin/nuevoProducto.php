...
*/
if (
    !empty($_POST["id_tipo_intrumento"]) && !empty($_POST["id_categoria"]) && !empty($_POST["id_marca"]) && !empty($_POST["color"])
    ...
    $instrumento->subirInstrumento(
        $_POST["id_tipo_intrumento"],
        $_POST["id_categoria"],
        $_POST["id_marca"],
        $_POST["color"],
        $_POST["modelo"],
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 text-center">
                        ...
                        <select class="custom-select my-1 mr-sm-2" name="id_marca" id="inlineFormCustomSelectPref">
