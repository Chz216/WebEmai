                            ...
                            <div class="col-lg-6">
                                <form>
                                    <div class="form-group bmd-form-group">
                                        <label for="exampleInput1" class="bmd-label-floating">Introduzca su nombre</label>
                                        <input type="nombre" class="form-control" id="exampleInput1">
                                        <span class="bmd-help">Nombre</span>
                                    </div>
                                    <div class="form-group bmd-form-group">
                                        <label for="exampleInput1" class="bmd-label-floating">Introduzca su correo electronico</label>
