...
if(isset($_POST["nombre"]) && isset($_POST["email"]) && isset($_POST["comentario"])){
    $cFormulario->subirFormulario($_POST["nombre"], $_POST["email"], $_POST["comentario"]);
}
?>
<!DOCTYPE html>
<!--
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="hero-content pb-5 text-center">
                                    <h1>Escuela Musical de Artes Integrales</h1>
                                    <div class="row">   
                                        <div class="col-xl-8 offset-xl-2"><p>Venta de instrumentos y accesorios de la mejor calidad. ¡Pregunta por nuestros precios! Contamos con clases de violín, piano, canto, batería, ukulele, bajo eléctrico, guitarra eléctrica y acústica. ¡No te preocupes por el instrumento!
                                            </p></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-6">
                                <form method="post" action="contacto.php" enctype="multipart/form-data">
                                    <div class="form-group bmd-form-group">
                                        <label for="exampleInput1" name="nombre" class="bmd-label-floating">Introduzca su nombre</label>
                                        <input type="nombre" name="nombre" class="form-control" id="exampleInput1">
                                        <span class="bmd-help">Nombre</span>
                                    </div>
                                    <div class="form-group bmd-form-group">
                                        <label for="exampleInput1" name="email" class="bmd-label-floating">Introduzca su correo electronico</label>
                                        <input type="email" name="email" class="form-control" id="exampleInput1">
                                        <span class="bmd-help">Correo</span>
                                    </div>
                                    <div class="form-group bmd-form-group">
                                        <label for="exampleInput1" name="comentario" class="bmd-label-floating">Introduzca Comentario</label>
                                        <textarea type="comentario" name="comentario" class="form-control" id="exampleInput1" rows="5"></textarea>
                            ...
                            <div class="col-lg-6">
                                ...
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3784.4997162171353!2d-97.39729248558412!3d18.461010475812362!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85c5bd27f93da751%3A0x278a4a39004c20f2!2sEscuela+de+M%C3%BAsica+Emai!5e0!3m2!1ses-419!2smx!4v1560561459018!5m2!1ses-419!2smx" width=100% height="300" frameborder="0" style="border:0" allowfullscreen></iframe>          
